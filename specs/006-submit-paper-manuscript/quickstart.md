# Quickstart: Submit a Paper Manuscript (UC-06)

**Date**: 2026-02-08

## Purpose

Validate the UC-06 manuscript upload flow for authors.
...
7. Upload a file exceeding size limits and verify “File exceeds maximum size of 50 MB.” (AT-UC07-03)
